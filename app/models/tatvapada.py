...
class Tatvapada(db_instance.Model):
    ...
    __table_args__ = (
        ...
        {
            'mysql_engine': 'InnoDB',  # ✅ InnoDB storage engine
            'mysql_charset': 'utf8mb4',  # ✅ Full Unicode
            'mysql_collate': 'utf8mb4_unicode_ci'  # ✅ Better for Kannada
        }
    )
    ...
    tatvapadakosha = Column(String(255, collation='utf8mb4_unicode_ci'), nullable=False)
    ...
    mukhya_sheershike = Column(String(255, collation='utf8mb4_unicode_ci'), nullable=True)
    ...
    tatvapada_hesaru = Column(String(255, collation='utf8mb4_unicode_ci'), nullable=True)
